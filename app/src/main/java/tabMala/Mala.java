...
public class Mala extends BaseFragment {
    ...
    private LinearLayout relativeLayoutthirdPearl;
    ...
    private void initialiseViews() {
        ...
        relativeLayoutthirdPearl = (LinearLayout)view.findViewById(R.id.relativeLayoutThirdPearl);
...
//                mala.beadCount(beadCount);
                if(beadCount==108){
                 ...
                 //   mala.malaCount(malaCount);
                    ...
                    relativeLayoutthirdPearl.setVisibility(View.GONE);
        ...
        relativeLayoutsecondPearl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(beadCount==108){
                    ...
                    relativeLayoutsecondPearl.setVisibility(View.GONE);
                    relativeLayoutfirstPearl.setVisibility(View.VISIBLE);
                    relativeLayoutthirdPearl.startAnimation(slide_top_bottom);


                }else{
                    relativeLayoutsecondPearl.startAnimation(slide_down);
                    relativeLayoutsecondPearl.setVisibility(View.GONE);
                    relativeLayoutthirdPearl.setVisibility(View.VISIBLE);
                    relativeLayoutthirdPearl.startAnimation(slide_top_bottom);
                }
                if(beadCount==108){
...
//                    relativeLayoutthirdPearl.setVisibility(View.GONE);
        ...
        relativeLayoutthirdPearl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {



//                relativeLayoutthirdPearl.startAnimation(slide_down);
  //              relativeLayoutthirdPearl.setVisibility(View.GONE);
                beadCount ++;
                if(beadCount==108){
//                    relativeLayoutsecondPearl.setVisibility(View.GONE);
