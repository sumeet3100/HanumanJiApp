 ...
 */
public class HanumanAartiHindi extends BaseFragment {
    ...
    public static final HanumanAartiHindi newInstance(String message)
    {
        HanumanAartiHindi f = new HanumanAartiHindi();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
       ...
       // frameLayout = (FrameLayout)view.findViewById(R.id.framelayout);
        ...
        loadTime(Constant.hanuman_aarti_hindi);
...
//									).add(R.id.container, new HanumanAartiEnglish()).addToBackStack("animation").commit();
    ...
    void loadTime(String data) {
        String page="<html><body>" +
                ...
                "                <td>\n" +
                "                    <style=\"font-family:Georgia;color:#521302;font-size:17px;\"><b>Hanuman Aarti</b>\n" +
                "                    \n" +
                "                </td><td><td><td><td><td><td><td><td><td><td><td>\n" +
                "                <td>\n" +
